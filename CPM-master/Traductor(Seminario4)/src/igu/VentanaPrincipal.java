...
public class VentanaPrincipal extends JFrame {
	...
	class BordeBoton extends MouseAdapter {
		@Override
	...
	private JButton getBtEspanol() {
		if (btEspanol == null) {
			...
			btEspanol.setFont(new java.awt.Font("Dialog", java.awt.Font.PLAIN,
					14));
		...
		this.addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent arg0) {
				int confirmado = JOptionPane.showConfirmDialog(null,
						"¿Seguro qué desea cerrar el programa?", "Salir",
	...
	class NumeroTeclado extends KeyAdapter {
		@Override
